          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <div className="relative group">
                <span className="text-gray-800 hover:bg-blue-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium cursor-pointer">Courses</span>
                <div className="absolute hidden group-hover:block bg-white border border-gray-200 rounded-md shadow-lg">
              ...
              <div className="relative group">
                <span className="text-gray-800 hover:bg-blue-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium cursor-pointer">Services</span>
                <div className="absolute hidden group-hover:block bg-white border border-gray-200 rounded-md shadow-lg">
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="relative">
              <span className="text-gray-800 hover:bg-blue-600 hover:text-white block px-3 py-2 rounded-md text-base font-medium cursor-pointer">Courses</span>
              <div className="ml-4">
                <Link href="/Courses/1" passHref>
            ...
            <div className="relative">
              <span className="text-gray-800 hover:bg-blue-600 hover:text-white block px-3 py-2 rounded-md text-base font-medium cursor-pointer">Services</span>
              <div className="ml-4">
                <Link href="/Services/1" passHref>
